...
int32_t generate(const model::LLama2Model& model, const std::string& sentence, int total_steps,
  ...
  // LOG(INFO)<<"total_steps:"<<total_steps;
...
int main(int argc, char* argv[]) {
  ...
  tensor::Tensor aa(base::DataType::DataTypeFp32,5,8);
  LOG(INFO) << "aa dims size:"<<aa.dims_size();
  ...
  const std::string& sentence = "Have a good day!";
