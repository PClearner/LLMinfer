...
std::pair<tensor::Tensor, tensor::Tensor> Model::slice_kv_cache(int32_t layer_idx,
  ...
  tensor::Tensor key(base::DataType::DataTypeFp32, config_->kv_dim_, false, nullptr,
                     key_cache_ptr);
  tensor::Tensor val(base::DataType::DataTypeFp32, config_->kv_dim_, false, nullptr,
                     val_cache_ptr);
...
tensor::Tensor Model::fill_input(const tensor::Tensor& pos_tensor,
  ...
  // LOG(INFO) << "pos:"<<pos<<"||input dims size:"<<input.dims_size();
  return input;
}
