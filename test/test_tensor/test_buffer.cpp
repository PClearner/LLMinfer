...
TEST(test_buffer, cuda_memcpy3)
{
  ...
  // cu to cu
  ASSERT_EQ(cu_buffer1.device_type(), DeviceType::DeviceCUDA);
  ASSERT_EQ(cu_buffer2.device_type(), DeviceType::DeviceCUDA);
...
TEST(test_buffer, cuda_memcpy4)
{
  ...
  ASSERT_EQ(cu_buffer1.device_type(), DeviceType::DeviceCUDA);
  ASSERT_EQ(cu_buffer2.device_type(), DeviceType::DeviceCPU);
